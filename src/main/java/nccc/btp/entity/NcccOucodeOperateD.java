...
@Setter
@Entity
@IdClass(NcccOucodeOperateD.ConfigId.class)
@Table(name = "NCCC_OUCODE_OPERATE_D")
public class NcccOucodeOperateD implements Serializable {
	...
	public static class ConfigId implements Serializable {
		...
		@Override
        public int hashCode() {
            return Objects.hash(year, version, oucode, gradeId, operateItemCode);
        }
