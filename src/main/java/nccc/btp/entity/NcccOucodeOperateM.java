...
@Setter
@Entity
@IdClass(NcccOucodeOperateM.ConfigId.class)
@Table(name = "NCCC_OUCODE_OPERATE_M")
public class NcccOucodeOperateM implements Serializable {
	...
	public static class ConfigId implements Serializable {
		...
		@Override
        public int hashCode() {
            return Objects.hash(year, version, oucode);
        }
