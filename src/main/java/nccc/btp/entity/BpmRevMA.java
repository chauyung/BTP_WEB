 ...
 */
@Entity
@Table(name = "BPM_REV_M_A")
public class BpmRevMA {

    /*
     * 主鍵
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_bpm_rev_m_a")
    @SequenceGenerator(name = "seq_bpm_rev_m_a", sequenceName = "SEQ_BPM_REV_M_A", allocationSize = 1)
