...
@Setter
@Entity
@IdClass(NcccHrGradeD.ConfigId.class)
@Table(name = "NCCC_HR_GRADE_D")
public class NcccHrGradeD implements Serializable {
	...
	public static class ConfigId implements Serializable {
		...
		@Override
        public int hashCode() {
            return Objects.hash(year, version, accounting, gradeId);
        }
