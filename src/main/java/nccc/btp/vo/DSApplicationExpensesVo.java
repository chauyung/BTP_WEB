...
public class DSApplicationExpensesVo extends ProcessVo{
    ...
    //董監事
    private List<NcccDirectorSupervisorList> ncccDirectorSupervisorListList;
    ...
    public DSApplicationExpensesVo(){
        ...
        this.setNcccDirectorSupervisorListList(new ArrayList<>());
    ...
    public List<NcccDirectorSupervisorList> getNcccDirectorSupervisorListList() {
        return ncccDirectorSupervisorListList;
    }

    public void setNcccDirectorSupervisorListList(List<NcccDirectorSupervisorList> ncccDirectorSupervisorListList) {
        this.ncccDirectorSupervisorListList = ncccDirectorSupervisorListList;
    }
